...
<body>
                          ...
                          <div class="col-md-5">
                            <div class="user-avatar">
                              <img src="<?php if (isset($row['image'])) {
                                          echo $row['image'];
                                        } ?>" alt="Upload Image" class="d-block rounded" height="150" width="150" id="uploadedAvatar" />
                            </div>
                          </div>
                          <div class="col-md-7">
                    ...
                    <form id="formAccountSettings" method="POST" onsubmit="return false">
                      <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                          ...
                          <input class="form-control" type="text" id="firstName" name="name" value="<?php if (isset($row['name'])) {
                                                                                                            echo $row['name'];
                                                                                                          }else{
                                                                                                            echo $_SESSION['name'];
                                                                                                          } ?>" autofocus />
                        ...
                        <div class="mb-3 col-md-6">
                          ...
                          <input class="form-control" type="text" id="email" name="email" value="<?php if (isset($row['email'])) {
                                                                                                    echo $row['email'];
                                                                                                  } ?>" />
                        </div>
                        ...
                        <div class="mb-3 col-md-6">
                          ...
                          <select id="Designation" name="Designation" class="select2 form-select">
                            <option value="<?php if (isset($row['Designation'])) {
                                              echo $row['Designation'];
                                            } ?>"><?php if (isset($row['Designation'])) {
                                                    echo $row['Designation'];
                                                  }else{
                                                    echo "Select";
                                                  } ?></option>
                        ...
                        <div class="mb-3 col-md-6">
                          ...
                          <select id="qualification" name="qualification" class="select2 form-select">
                            <option value="<?php if (isset($row['qualification'])) {
                                              echo $row['qualification'];
                                            } ?>"><?php if (isset($row['qualification'])) {
                                                    echo $row['qualification'];
                                                  }else{
                                                    echo "Select";
                                                  } ?></option>
                        ...
                        <div class="mb-3 col-md-6">
                          ...
                          <select id="gender" name="gender" class="select2 form-select">
                            ...
                            <option value="Not Confirming">Not Confirming</option>
                    ...
                    $(document).ready(function() {
                      $('#formAccountSettings').submit(function(e) {
                        ...
                        $.ajax({
                          ...
                          data: formData,
                          success: function(response) {
                            $('#success').html('<div class="alert alert-success w-50" role="alert">Profile Updated Successfully!</div>');

                          },
                          error: function(xhr, status, error) {
                            $('#success').html('< class="alert alert-danger w-50" role="alert">Error</div>');
  ...
  <script src="http://localhost/doctor/Client/assets/vendor/libs/jquery/jquery.js"></script>
  <script src="http://localhost/doctor/Client/assets/vendor/libs/popper/popper.js"></script>
  <script src="http://localhost/doctor/Client/assets/vendor/js/bootstrap.js"></script>
  <script src="http://localhost/doctor/Client/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
  <script src="http://localhost/doctor/Client/assets/vendor/js/menu.js"></script>
  ...
  <!-- Main JS -->
  <script src="http://localhost/doctor/Client/assets/js/main.js"></script>

  <!-- Page JS -->
  <script src="http://localhost/doctor/Client/assets/js/pages-account-settings-account.js"></script>
