...
<html lang="en" class="light-style layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="../../Client/assets/" data-template="vertical-menu-template-free">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.php" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold ms-2">Doctor App</span>
                    </a>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            ...
                            <div class="table-responsive text-nowrap">
                                ...
                                <script type="text/javascript" src="php-ajax/js/jquery.js"></script>
                                <script type="text/javascript">
                                    $(document).ready(function() {
                                        // Load Table Records
                                        function loadTable() {
                                            $.ajax({
                                                url: "php-ajax/load-posts.php",
                                                type: "POST",
