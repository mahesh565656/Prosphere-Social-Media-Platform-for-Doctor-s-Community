...
<div class="container">
    <form class="form" method="post" action="signup-user.php">
        ...
        <input type="submit" name="signup"  class="button-submit">
        <div class="link login-link text-center">Already a member? <a href="login-user.php">Login</a></div>
